...
# # Load your dataset
# data = pd.read_csv(r"C:\\Users\\VICTUS\\OneDrive\\Desktop\\Maverick\\OverallRanking_2017.csv")  # Replace 'your_dataset.csv' with your dataset file
# # Prepare your data
...
# Load your dataset
data = pd.read_csv('./OverallRanking_2017.csv')  # Replace 'your_dataset.csv' with your dataset file
...
import joblib
joblib.dump(rf_regressor,'model2017.joblib')
